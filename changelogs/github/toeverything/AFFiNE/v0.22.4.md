...
* fix: size of canvas in `PDFPageRenderer` by @mkihr-ojisan in https://github.com/toeverything/AFFiNE/pull/12722
* fix(editor): toolbar shaking when setting inline style by @fundon in https://github.com/toeverything/AFFiNE/pull/12765
