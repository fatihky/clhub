...
export const rubygemsPackages: Package[] = [
  new Package(pm, 'devise', 'https://github.com/heartcombo/devise', undefined, { tagPrefix: 'v' }),
  new Package(pm, 'paper_trail', 'https://github.com/paper-trail-gem/paper_trail', undefined, {
